...
$selsql = "SELECT * FROM tbl_employee WHERE id = '" . mysqli_real_escape_string($conn, $_SESSION["emp_id"]) . "'";
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right pullDown">
                            ...
                            <a href="#" class="dropdown-item has-icon"> <i class="far
                                ...
                                <a href="<?php echo BASE_URL; ?>employee/logout.php" class="dropdown-item has-icon text-danger"> <i class="fas fa-sign-out-alt"></i>
                                    Logout
                                </a>
                        </div>
                    </li>
